...
const Navbar = () => {
    ...
    return (
        /* 🎨 স্ক্রিনশটের হুবহু ডার্ক নেভি ব্লু ব্যাকগ্রাউন্ড এবং নিচের বেগুনি বর্ডার */
        <nav className="bg-[#091d2c] border-b-4 border-[#7a60eb] shadow-lg">
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center py-4 gap-4">
                    {/* লোগোর নাম এবং আইকন আগের মতোই অপরিবর্তিত রাখা হয়েছে */}
