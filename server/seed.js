...
const events = [
    ...
    },
    {
        ...
        totalSeats: 500,
        ticketPrice: 1500,
        imgUrl: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&q=80&w=800'
    },
    {
    ...
    },
    {
        ...
        totalSeats: 300,
        ticketPrice: 200,
        imgUrl: 'https://images.unsplash.com/photo-1536924940846-227afb31e2a5?auto=format&fit=crop&q=80&w=800'
    },
    {
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/eventlisener');
        ...
        // ১. ইউজার ডাটা ইনসার্ট ও পাসওয়ার্ড হ্যাশ
        ...
        // ৩. বুকিং ডাটা জেনারেট (আপনার মডেলের এনাম ও ফিল্ড অনুযায়ী নিখুঁত ম্যাচ)
        const bookingsData = [];
        ...
        for (const event of createdEvents) {
            ...
            for (const user of selectedUsers) {
                // মডেল এনাম ম্যাচিং: ['pending', 'confirmed', 'cancelled']
                const statuses = ['pending', 'confirmed', 'cancelled'];
                const status = statuses[Math.floor(Math.random() * statuses.length)];

                // মডেল এনাম ম্যাচিং: ['non-paid', 'paid', 'failed']
                ...
                bookingsData.push({
                    userId: user._id,              // মডেলে রিকোয়ার্ড userId
                    event: event._id,              // মডেলে রিকোয়ার্ড event
                    numberOfTickets: 1,            // মডেলে রিকোয়ার্ড numberOfTickets
                    totalPrice: event.ticketPrice, // মডেলে রিকোয়ার্ড totalPrice
                    status: status,                // মডেলে রিকোয়ার্ড status [enum]
                    paymentStatus: paymentStatus,  // মডেলে রিকোয়ার্ড paymentStatus ['non-paid', 'paid']
                    amount: event.ticketPrice      // মডেলে রিকোয়ার্ড amount
                });
